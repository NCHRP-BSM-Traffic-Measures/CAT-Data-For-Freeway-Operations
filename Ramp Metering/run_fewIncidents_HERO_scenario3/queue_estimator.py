...
class QueueEstimator(object):
    ...
    def process_time_step(self, bsm_dict, occupancy_dict, flow_dict, timestep_start_seconds):
        ...
        # MAKE THIS SO THAT EVERY RAMP AND LANE ARE ALWAYS REPRESENTED IN NEW DUMMY DATA
        ...
        # DROP COLUMNS CURRENTLY NOT IN THE MODEL, REMOVE LATER
        #X_cols = [c for c in X.columns if 'flow' not  in c]
        #X = X[X_cols[
