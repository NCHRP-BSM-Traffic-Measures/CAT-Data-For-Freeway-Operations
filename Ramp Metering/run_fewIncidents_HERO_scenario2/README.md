...
This folder contains the source codes 1) running the simualtion of I-210 (from postmile 28 to postmile 38) under the queue-informed system-wide ramp metering enhanced by the CAT data (Scenario 2) and 2) saving the results.
